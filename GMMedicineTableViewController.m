//
//  GMMedicineTableViewController.m
//  DogFood
//
...
@interface GMMedicineTableViewController ()

@end

@implementation GMMedicineTableViewController
{
    NSArray *medicines;
...
@synthesize delegate, medicine, firstLevel;
...
- (void)viewDidLoad
{
    ...
    medicines = [firstLevel objectForKey:@"Medicine"];    

    selectedIndex = [medicines indexOfObject:self.medicine];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    // Add text to cell
    cell.textLabel.text = [medicines objectAtIndex:indexPath.row];
    cell.detailTextLabel.text = @"";    
    
    // Checkmark medicine selected    
    ...
    if ((healthCarePressed || breedPressed) || ([selectOne isEqualToString:@"Select One"]))
    {
        cell.accessoryType = UITableViewCellAccessoryNone;
    }
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
	...
	cell.accessoryType = UITableViewCellAccessoryCheckmark;
	NSString *theMedicine = [medicines objectAtIndex:indexPath.row];
	[self.delegate gMMedicineTableViewController:self didSelectMedicine:theMedicine];
}
